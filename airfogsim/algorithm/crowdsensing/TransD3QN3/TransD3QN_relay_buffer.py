...
class ReplayBuffer:
    ...
    # 填充经验池
    def add(self, node_state, mission_state, action, reward,
            next_node_state,  next_mission_state, done):
        self.buffer.append((node_state, mission_state, action, reward,
            next_node_state,  next_mission_state, done))
    ...
    def sample(self, batch_size):
        ...
        node_state, mission_state, action, reward, next_node_state,  next_mission_state, done = zip(
            *transitions)
        # 将state变成数组，后面方便计算
