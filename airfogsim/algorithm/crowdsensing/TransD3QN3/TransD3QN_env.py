...
class TransD3QN_Env:
    ...
    def takeAction(self,node_state,  mission_state):
        """
        Args:
        ...
        is_random, max_q_value, action = self.agent.take_action(node_state,  mission_state)
        # 平滑处理最大state_value
    ...
    def addExperience(self,node_state,  mission_state, action, reward,next_node_state,  next_mission_state,done):
        # 添加到经验池
        self.agent.remember(node_state,  mission_state, action, reward, next_node_state,  next_mission_state, done)
