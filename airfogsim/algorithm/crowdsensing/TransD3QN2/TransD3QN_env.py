...
from .TransD3QN_model import TransD3QN
...
class TransD3QN_Env:
    ...
    def __init__(self, dim_args, train_args):
        ...
        # 实例化 TransD3QN
        self.agent = TransD3QN(dim_args, train_args)

    def takeAction(self,  mission_state, sensor_state, sensor_mask):
        """
        Args:
        ...
        is_random, max_q_value, action = self.agent.take_action(mission_state, sensor_state, sensor_mask)
        # 平滑处理最大state_value
    ...
    def addExperience(self, mission_state, sensor_state, sensor_mask, action, reward,next_mission_state, next_sensor_state, next_sensor_mask,done):
        # 添加到经验池
        self.agent.remember(mission_state, sensor_state, sensor_mask, action, reward, next_mission_state, next_sensor_state, next_sensor_mask, done)
