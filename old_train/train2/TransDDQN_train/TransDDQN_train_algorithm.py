...
if cuda_num > 0:
    ...
    TransDDQN_device = "cpu"

print('torch_version: ',torch.__version__)
print('gpu_num: ',cuda_num)
print('device: ',TransDDQN_device)
...
class TransDDQN_Train_AlgorithmModule(BaseAlgorithmModule):
    """
    ...
    def initialize(self, env: AirFogSimEnv, config={}, last_episode=None,final=False):
        ...
        if last_episode is not None and last_episode > 0:
            self.TransDDQN_env.loadModel(last_episode,final)
    ...
    def train(self, env: AirFogSimEnv):
        ...
        loss=self.TransDDQN_env.train()
        return loss

    def saveModel(self, episode,final):
        self.TransDDQN_env.saveModel(episode,final)
