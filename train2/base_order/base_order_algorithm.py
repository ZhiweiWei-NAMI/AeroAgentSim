...
class OrderAlgorithmModule(BaseAlgorithmModule):
    """Order Algorithm Module
    ...
    scheduleTraffic: UAV: Go to next mission position according to the order of mission arrival.
    '''

    def __init__(self):
        super().__init__()
        self.algorithm_module_tag="Order"
