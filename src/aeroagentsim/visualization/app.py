...
from .data_service import SimulationDataService, _default_runtime_dir
...
DB_PATH = Path(
    os.getenv("AEROAGENTSIM_DB_PATH")
    or os.getenv("AIRFOGSIM_DB_PATH")
    or str(_default_runtime_dir() / "lowspace_sim.db")
)
os.environ.setdefault("AEROAGENTSIM_DB_PATH", str(DB_PATH))
