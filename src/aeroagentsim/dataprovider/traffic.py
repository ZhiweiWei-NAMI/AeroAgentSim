...
if TYPE_CHECKING:
    ...
    # from aeroagentsim.core.agent import Agent # No longer needed for on_traffic_update
    # from aeroagentsim.manager.landing import LandingManager # No longer needed for on_traffic_update
    from aeroagentsim.manager.airspace import AirspaceManager # Import AirspaceManager
