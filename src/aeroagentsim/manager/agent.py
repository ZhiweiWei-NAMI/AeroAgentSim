...
from aeroagentsim.core.agent import Agent, AgentMeta
    ...
    def _discover_agent_classes(self):
        ...
        try:
            ...
            for _, module_name, is_pkg in pkgutil.iter_modules([str(agent_path)]):
                ...
                try:
                    # 导入模块
                    module = importlib.import_module(f"aeroagentsim.agent.{module_name}")
            ...
            logger.error("Error: 无法导入 aeroagentsim.agent 包")
