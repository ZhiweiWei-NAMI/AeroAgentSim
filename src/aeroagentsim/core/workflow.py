...
from aeroagentsim.core.enums import WorkflowStatus, TaskStatus, TriggerOperator, TriggerType
from aeroagentsim.core.trigger import StateTrigger, EventTrigger, TimeTrigger, CompositeTrigger, Trigger
...
class Workflow(metaclass=WorkflowMeta):
    ...
    def _add_priority_to_task(self, task_dict: Dict) -> Dict:
        ...
        if 'priority' not in task_dict['properties']:
            # 获取工作流的优先级属性
            from aeroagentsim.core.enums import TaskPriority
