...
import simpy
from aeroagentsim.manager.file import FileManager
...
from aeroagentsim.manager.payload import PayloadManager
...
from aeroagentsim.core.dataprovider import DataProvider # Import DataProvider
import aeroagentsim.task as airfogsim_task
import aeroagentsim.agent as airfogsim_agent
import aeroagentsim.component as airfogsim_component
import aeroagentsim.workflow as airfogsim_workflow
...
class Environment(simpy.Environment):
    ...
    def create_composite_trigger(self, triggers: List[Trigger],
                               ...
                               name: Optional[str] = None):
        from aeroagentsim.manager.trigger import TriggerOperator
