...
def check_workflow_classes(env: Environment) -> None:
    ...
    # 从 aeroagentsim.workflow 模块获取所有工作流类
    import aeroagentsim.workflow as workflow_module
    workflow_classes = workflow_module.get_all_workflow_classes()
