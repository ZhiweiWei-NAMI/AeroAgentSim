...
EXAMPLES = {
    ...
    "run_multi_task_contract.py": {
        "description": "多任务合约示例",
        "requires": [],
        "timeout": 20,
        "expected_exit_code": 0
    },
    "run_drone_inspection.py": {
        "description": "无人机巡检工作流示例",
        "requires": [],
        "timeout": 60,
        "expected_exit_code": 0
    },
    "run_logistics_simulation.py": {
        "description": "物流工作流示例，较为复杂，耗时较长",
        "requires": [],
        "timeout": 180,
        "expected_exit_code": 0
    },
    "run_traffic_simulation.py": {
