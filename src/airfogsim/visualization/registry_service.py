...
from airfogsim.core.agent import AgentMeta
from airfogsim.core.enums import TriggerOperator, WorkflowStatus
from airfogsim.core.task import Task
from airfogsim.core.workflow import Workflow, WorkflowMeta
...
class RegistryService:
    ...
    def __init__(
        self,
        base_dir: str = "registry/aeroagentsim",
        runtime_dir: str = "runtime/aeroagentsim",
    ) -> None:
