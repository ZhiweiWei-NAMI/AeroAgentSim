"""
AirFogSim LLM Response Parser Module

This module provides powerful parsing functionality for handling various response formats from LLM.
Main features include:
1. JSON format pattern recognition and extraction
2. YAML format pattern recognition and extraction  
3. Automatic repair of common format errors
4. Detailed error reporting and debugging information
