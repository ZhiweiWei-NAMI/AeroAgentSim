...
class TriggerManager:
    ...
    def __init__(self, env):
        ...
        self.manager_id = f"trigger_manager_{id(self)}"
        self._register_manager_events()
        
    def _register_manager_events(self):
        """注册管理器事件"""
        self.env.event_registry.register_event(self.manager_id, 'trigger_created')
        self.env.event_registry.register_event(self.manager_id, 'trigger_activated')
